...
class Anticor(Algo):
    ...
    def __init__(self, window=28, c_version=True):
        """
    ...
    def weights(self, X):
        ...
        print('antiCor: weights: ', weights, 'weights.shape: ', weights.shape)
        ...
        if self.c_version is False:
            for t in range(n - 1):
                ...
                # print('t+1: ', t+1, '-------weights[t+1,:]', weights[t + 1, :])
        ...
        print('got weights: ', weights, 'weights.shape: ', weights.shape)
...
if __name__ == '__main__':
    ...
    tools.quickrun(Anticor(), tools.dataset(datasetName))
