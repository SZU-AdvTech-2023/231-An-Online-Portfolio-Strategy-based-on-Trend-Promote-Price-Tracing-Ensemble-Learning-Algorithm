...
def profile(algo, data=None, to_profile=[]):
    ...
    profile = line_profiler.LineProfiler(*to_profile)
...
def quickrun(algo, data=None, n=1000, **kwargs):
    ...
    print(result.search())
    # print("result.getreturncw():",result.getreturncw())
    result.plot(**kwargs)
    plt.show()
    return result
    # return result.getreturncw()
...
if __name__ == '__main__':
    # datasetName = '/home/yhg/PycharmProjects/portfolio-risk/UPalgoTest/universal/data/djia'
